...
public enum VkMemoryDecompressionMethodFlagsEXT : uint64
{
	...
	VK_MEMORY_DECOMPRESSION_METHOD_GDEFLATE_1_0_BIT_NV = 0,
	// Pretty names
...
public enum VkPresentScalingFlagsKHR : uint32
{
	...
	VK_PRESENT_SCALING_ONE_TO_ONE_BIT_EXT = 0,
	VK_PRESENT_SCALING_ASPECT_RATIO_STRETCH_BIT_KHR = 2,
	VK_PRESENT_SCALING_ASPECT_RATIO_STRETCH_BIT_EXT = 0,
...
public enum VkPresentGravityFlagsKHR : uint32
{
	...
	VK_PRESENT_GRAVITY_MIN_BIT_EXT = 0,
	VK_PRESENT_GRAVITY_MAX_BIT_KHR = 2,
	VK_PRESENT_GRAVITY_MAX_BIT_EXT = 0,
